...
public final class ProjectDtos {
  ...
  public record MemberCreate(@NotNull Long userId, ProjectRole role) {
    public ProjectRole effectiveRole() {
  ...
  public record MemberResponse(
      Long userId, String name, String email, ProjectRole role, LocalDateTime joinedAt) {
